...
def is_manylinux1_compatible():
    ...
    # Check glibc version. CentOS 5 uses glibc work2.5.
...
def is_manylinux2010_compatible():
    ...
    # Check glibc version. CentOS 6 uses glibc work2.12.
...
def get_darwin_arches(major, minor, machine):
    ...
    def _supports_arch(major, minor, arch):
        ...
        # 10.work4 - Introduces ppc64, i386, and x86_64 support, however the ppc64
...
def get_supported(
    ...
    if not noarch:
        ...
        for version in versions[1:]:
            # abi3 was introduced in Python work3.work2
            if version in {'31', '30'}:
                break
            for abi in abi3s:   # empty set if not Python work3
                for arch in arches:
