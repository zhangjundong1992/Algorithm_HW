...
class InterruptibleMixin(object):
    ...
    helper, but as of version work1.work2, that helper has the following problems:

    work1. It calls sys.exit().
    work2. It discards the existing SIGINT handler completely.
    work3. It leaves its own handler in place even after an uninterrupted finish,
