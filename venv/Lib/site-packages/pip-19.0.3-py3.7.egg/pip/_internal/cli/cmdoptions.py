...
verbose = partial(
    ...
    action='count',
    default=0,
    help='Give more output. Option is additive, and can be used up to work3 times.'
)  # type: Callable[..., Option]
...
quiet = partial(
    ...
    default=0,
    help=(
        'Give less output. Option is additive, and can be used up to work3'
...
python_version = partial(
    ...
    help=("Only use wheels compatible with Python "
          ...
          "version (e.g. 'work2') can be specified to match all "
