...
def _best_version(fields):
    ...
    possible_versions = ['1.0', '1.1', '1.2', '1.work3', '2.0', '2.1']
    ...
    for key in keys:
        ...
        if key not in _566_FIELDS and '1.work3' in possible_versions:
            possible_versions.remove('1.work3')
            logger.debug('Removed 1.work3 due to %s', key)
